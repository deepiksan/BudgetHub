...
typedef struct out_files {
   ...
   char  outfile2[ MaxFileName + 1 ];// = "a";
   char  outfile3[ MaxFileName + 1 ];// = "b";
} Outfile;
              ...
              char* out_file )
{
   ...
   //fprintf( fp, "%5d   %5d\n", v, e );
   fprintf( fp, "p edge %5d   %5d\n", v, e );

   for ( i = 0; i < e; i++ )
      //fprintf( fp, "%5d   %5d   %5d\n", 1 + ran( v ), 1 + ran( v ), weight_flag ? 1 + ran( max_wgt ) : 1 );
      fprintf( fp, "e	%5d   %5d\n", 1 + ran( v ), 1 + ran( v ));
